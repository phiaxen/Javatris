...
public class ShapeHandler extends AbstractModel {
	...
	private Shape getShape(int shape) {
		switch (shape) {
		case 0:
			return new Shape(2, new int[][] { { 1, 1, 1, 1 } }); // I
		case 1:
			return new Shape(3, new int[][] { { 1, 1, 0 }, { 0, 1, 1 } }); // Z
		case 2:
			return new Shape(4, new int[][] { { 0, 1, 1 }, { 1, 1, 0 } }); // S
		case 3:
			return new Shape(5, new int[][] { { 0, 0, 1 }, { 1, 1, 1 } }); // L
		case 4:
			return new Shape(6, new int[][] { { 1, 1, 1 }, { 0, 0, 1 } }); // J
		case 5:
			return new Shape(7, new int[][] { { 1, 1, 1 }, { 0, 1, 0 } }); // T
		case 6:
			return new Shape(8, new int[][] { { 1, 1 }, { 1, 1 } }); // Box
		default:
			return null;
		}
	}
	...
	/**
	 * Returns the next shape in the list and updates the list of shapes. Notifies
	 * any listeners
	 * 
	 ...
	 * 
	 * @param currentShape is the currentShape
	 */
